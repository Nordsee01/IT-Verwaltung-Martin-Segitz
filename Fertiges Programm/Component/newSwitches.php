...
if ($newComponentIsValid) {
    ...
    $insertManager->komponenteHinzufuegen($_POST["Bezeichnung"], $_POST["Raum"], $_POST["Hersteller"], $_POST["Einkaufsdatum"], $_POST["Gewaehrleistungsdauer"], $_POST["Notiz"], $_POST["Hersteller"], 2);

    $komponenten_k_id = $DBSelect->getComponentIDWhere($_POST["Bezeichnung"], $_POST["Raum"], $_POST["Hersteller"], $_POST["Einkaufsdatum"], $_POST["Gewaehrleistungsdauer"], $_POST["Notiz"], $_POST["Hersteller"], 2);

    $insertManager->khaHinzufuegen($komponenten_k_id, $komponentenattribute_kat_id, $_POST["Seriennummer"]);
    $insertManager->khaHinzufuegen($komponenten_k_id, $komponentenattribute_kat_id, $_POST["Ports"]);
    $insertManager->khaHinzufuegen($komponenten_k_id, $komponentenattribute_kat_id, $_POST["Uplink"]);
}
$DBSelect = new DBSelect();
?>
...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <label for="Ports">Ports Anzahl</label>
                <input name="Ports" type="text" class="form-control" id="Ports" aria-describedby="Ports" required>
            </div>
            <div class="form-group">
                <label for="Uplink">Uplink Typ</label>
                <input name="Uplink" type="text" class="form-control" id="Uplink" aria-describedby="Uplink" required>
            </div>
