...
if ($newComponentIsValid) {
    ...
    $insertManager->komponenteHinzufuegen($_POST["Bezeichnung"], $_POST["Raum"], $_POST["Hersteller"], $_POST["Einkaufsdatum"], $_POST["Gewaehrleistungsdauer"], $_POST["Notiz"], $_POST["Hersteller"], 3);

    $insertManager->khaHinzufuegen($komponenten_k_id, 1, $_POST["Seriennummer"]);
    $insertManager->khaHinzufuegen($komponenten_k_id, 7, $_POST["Ports"]);
    $insertManager->khaHinzufuegen($komponenten_k_id, 8, $_POST["IPAdressen"]);
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <label for="Ports">Anzahl Ports</label>
                <input name="Ports" type="text" class="form-control" id="Ports" aria-describedby="Ports" required>
            </div>
            <div class="form-group">
                <label for="IPAdressen">IP-Adressen</label>
                <input name="IPAdressen" type="text" class="form-control" id="IPAdressen" aria-describedby="IPAdressen" required>
            </div>
