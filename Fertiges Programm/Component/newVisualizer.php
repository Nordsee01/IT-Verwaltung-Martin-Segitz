...
if ($newComponentIsValid) {
    ...
    $insertManager->komponenteHinzufuegen($_POST["Bezeichnung"], $_POST["Raum"], $_POST["Hersteller"], $_POST["Einkaufsdatum"], $_POST["Gewaehrleistungsdauer"], $_POST["Notiz"], $_POST["Hersteller"], 7);

    $komponenten_k_id = $DBSelect->getComponentIDWhere($_POST["Bezeichnung"], $_POST["Raum"], $_POST["Hersteller"], $_POST["Einkaufsdatum"], $_POST["Gewaehrleistungsdauer"], $_POST["Notiz"], $_POST["Hersteller"], 7);

    $insertManager->khaHinzufuegen($komponenten_k_id, 1, $_POST["Seriennummer"]);
    $insertManager->khaHinzufuegen($komponenten_k_id, 17, $_POST["Anschlusstyp"]);
...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <label for="Anschlusstyp">Anschlusstyp</label>
                <input name="Anschlusstyp" type="text" class="form-control" id="Anschlusstyp" aria-describedby="Anschlusstyp" required>
            </div>
